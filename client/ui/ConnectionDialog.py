...
class Ui_ConnectionDialog(object):
    def setupUi(self, ConnectionDialog):
        ...
        self.recent_connections_list = QtWidgets.QListWidget(self.recent_tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tls_checkbox = QtWidgets.QCheckBox(self.connection_groupbox)
        self.tls_checkbox.setObjectName("tls_checkbox")
        self.nickname_layout.addWidget(self.tls_checkbox)
    ...
    def retranslateUi(self, ConnectionDialog):
        ...
        self.tls_checkbox.setStatusTip(_translate("ConnectionDialog", "Encrypt the connection with TLS. The server must be started with TLS too."))
        self.tls_checkbox.setText(_translate("ConnectionDialog", "TLS"))
